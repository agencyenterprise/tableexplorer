...
export interface BridgeLandERC721Interface extends utils.Interface {
  functions: {
    "allowedMinter()": FunctionFragment;
    ...
    "setAllowedMinter(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setAllowedMinter",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export interface BridgeLandERC721 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BridgeLandERC721Interface;
  ...
  functions: {
    allowedMinter(overrides?: CallOverrides): Promise<[string]>;
    ...
    setAllowedMinter(
      _allowedMinter: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  estimateGas: {
    allowedMinter(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    allowedMinter(overrides?: CallOverrides): Promise<PopulatedTransaction>;
